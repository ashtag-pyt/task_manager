...
export default function page() {
  ...
  return (
    <>
      <nav className="flex justify-between  ml-20 border-b bg-black border-violet-100 p-4">
          <h1 className="text-4xl text-neutral-200">Calendar</h1>
        {/* <h1 className="font-bold text-2xl text-gray-700">Calendar</h1> */}
      </nav>
      <main className="flex min-h-screen flex-col ml-20 items-center justify-between p-24">
