    ...
    <main className="w-full h-screen bg-black flex flex-row relative">
      <section className="flex flex-col p-10 mt-30 ml-20 w-full gap-5">
        ...
        <div className="flex flex-row gap-5 w-full">
               ...
               <div className="border-neutral-500/50 flex flex-col w-1/2 bg-neutral-800/20 rounded-md border p-4">
                    <h2 className="text-xl text-neutral-200 mb-4 ">Recently Completed Tasks</h2>
                    <Table/>
              ...
              <div className="border-neutral-500/50 flex flex-col w-1/2 bg-neutral-800/20 rounded-md border p-4">
                         ...
                         <h2 className="text-xl text-neutral-200 mb-4">Recently Created Tasks</h2>
                         <Table/>
